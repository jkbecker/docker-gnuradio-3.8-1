...
class transceiver_OQPSK(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.0007, 0, 0, "")
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/root/gnuradio/zigbee_packets_4msps_2G48.dat', False)
        ...
        self.connect((self.blocks_throttle_0, 0), (self.ieee802_15_4_oqpsk_phy_0, 0))
